# Migration `20200729222557-12`

This migration has been generated by Taykavol at 7/29/2020, 10:25:57 PM.
...
ALTER TABLE "public"."Curriculum" ADD FOREIGN KEY ("courseID")REFERENCES "public"."Course"("id") ON DELETE SET NULL ON UPDATE CASCADE
...
migration 20200729222447-1..20200729222557-12
--- datamodel.dml
+++ datamodel.dml
@@ -2,133 +2,133 @@
